...
class MakeRepository extends Command
{
    ...
    {
        $name = str_replace(config("easy-laravel-package.repository_interface_suffix"), "", $this->argument("name"));
    ...
    {
        $repositoryInterfaceNamespace = config("easy-laravel-package.repository_namespace") . "\\".$className;
        $repositoryInterfaceName = $className . config("easy-laravel-package.repository_interface_suffix");
        $stubProperties = [
    ...
    {
        $repositoryNamespace = config("easy-laravel-package.repository_namespace") . "\\" . $className;

        $repositoryName = $className . config("easy-laravel-package.repository_suffix");
        $stubProperties = [
    ...
    {
        return config("easy-laravel-package.repository_namespace") . "\\". $className;
    }
    ...
    {
        return $this->appPath() . "/" .
            config("easy-laravel-package.repository_directory") .
            "/$className/$className" . config("easy-laravel-package.repository_interface_suffix") . ".php";
    }
    ...
    {
        $path = $isDefault
            ? "/" . $className . "/$className" . config("easy-laravel-package.repository_suffix").".php"
            : "/Other/$className" .  config("easy-laravel-package.repository_suffix") . ".php";

        return $this->appPath() . "/" .
            config("easy-laravel-package.repository_directory") . $path;
    }
    ...
    {
        $this->ensureDirectoryExists(config("easy-laravel-package.repository_directory"));
        $this->ensureDirectoryExists(config("easy-laravel-package.repository_directory") . "/". $className);
        $this->ensureDirectoryExists(config("easy-laravel-package.repository_directory") . "/" . $className);
    }
}
